...
const phases = [
  {
    ...
    icon: FaMicroscope,
    description:
      "Online exam on our system, covering Anatomy and Physiology, Biochemistry and Cell Biology, Ecology, and Genetics and Evolution",
    Date: "15th of August",
    color: "text-emerald-400"
  },
  {
    ...
    icon: FaFlask,
    description:
      "Top 16 teams participate in a match like game, facing off in a head-to-head competition.",
    Date: "29th of August",
    color: "text-teal-400"
  }
];
      ...
      <section className="min-h-screen py-16 md:py-24 lg:py-32 px-4 relative flex items-center justify-center">
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          >
            ...
            <p
              className={`text-lg md:text-xl lg:text-2xl max-w-3xl mx-auto leading-relaxed px-4 ${
                isDark ? "text-gray-300" : "text-gray-700"
              }`}
            >
              The BioLeague competition aims to inspire young investigators to delve deeper into biology through a competitive and collaborative environment during an eight-week period of intensive communication and engagement.
            </p>
      ...
      <section className="py-16 md:py-24 lg:py-32 px-4 relative">
        ...
        <div className="relative max-w-7xl mx-auto">
          ...
          >
            ...
            <p className={`${isDark ? "text-gray-400" : "text-gray-700"} text-base md:text-lg lg:text-xl`}></p>
          </motion.div>
              ...
              return (
                ...
                >
                  ...
                  <div className="relative">
                    ...
                    <div
                      className={`inline-flex items-center gap-2 ${phase.color} text-sm md:text-base font-semibold`}
                    >
      ...
      <section className="py-16 md:py-24 lg:py-32 px-4 relative">
        ...
        <div className="relative max-w-7xl mx-auto">
          ...
          >
            ...
            <p className={`${isDark ? "text-gray-400" : "text-gray-700"} text-xl`}>
              Celebrating our outstanding participants
            </p>
          </motion.div>
            ...
            >
              <table className="w-full">
                <thead>
                  ...
                  >
                    <th
                      className={`p-6 text-left font-bold ${
                ...
                >
                  {winnersResults
                    .slice(0, showAllWinners ? winnersResults.length : 3)
                    .map((team) => (
                      <motion.tr
                        key={team.teamName}
                      ...
                      >
                        ...
                        <td className={`p-6 ${isDark ? "text-gray-300" : "text-gray-700"}`}>
                          {team.members.join(", ")}
                        </td>
                      </motion.tr>
                    ))}
