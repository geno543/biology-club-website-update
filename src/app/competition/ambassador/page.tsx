        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
          ...
          >
            ...
            <p className="mt-4 text-lg leading-8 text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              Fill out the form below to register for ambassador.
            </p>
          </motion.div>
        </div>
      </div>
      ...
      <div className="relative mx-auto max-w-5xl px-6 lg:px-8 pb-12"> {/* Reduced bottom padding */}
        ...
        >
          ...
          <div className="aspect-w-16 aspect-h-9">
            <iframe
              src="https://docs.google.com/forms/d/e/1FAIpQLSd2Bj86VQPti_YLbEf8lthdYjsn5UuLUegupW2DJXKTi6APRQ/viewform?embedded=true"
              width="640px"
              height="612px"
              frameBorder="0"
              marginHeight={0}
